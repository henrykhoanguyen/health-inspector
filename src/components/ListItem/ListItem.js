            ...
            <div className = {containerClasses}>
                <div className = "result-list-item">
                    <div className = "result-list-item-description">
                        ...
                        <p className = "result-list-item-last-updated">Last Updated: {date.format('MM DD YYYY')}</p>
                    </div>
                    <div className = "result-list-item-badge">
                        <img src={badge} alt={this.props.restaurant.results} title={this.props.restaurant.title}/>
                    </div>
                </div>
            </div>
        )
